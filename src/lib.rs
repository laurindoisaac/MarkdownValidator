// src/lib.rs
/*
 * Core library for MarkdownValidator
 */
...
#[derive(Debug)]
pub struct MarkdownValidatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MarkdownValidatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MarkdownValidator processing");
    
    let mut processor = MarkdownValidatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MarkdownValidatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MarkdownValidatorProcessor::new(false);
